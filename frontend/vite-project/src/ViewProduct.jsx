...
const ViewProduct = () => {
    ...
    const loadData = async () => {
        let api = "https://e-commerce-project2-2.onrender.com/products/productdatashow";
                ...
                <Row className="justify-content-center">
                    <Col md={6} className="image-column">
                        <Card className="text-center m-3">
                            <Card.Img variant="top" src={`https://e-commerce-project2-2.onrender.com/${bigImage}`} className="main-image" />
                                ...
                                {proData.images && proData.images.length > 0 ? (
                                    proData.images.map((item, index) => (
                                        <img 
                                            ...
                                            src={`https://e-commerce-project2-2.onrender.com/${item}`} 
                                            alt={`Thumbnail ${index}`} 
                                        />
                                    ))
                                ) : (
